...
// module.exports = async function Invoke_Hyperledger(_function_name, _user,_key, _value) {
...
//         await gateway.connect(ccp, { wallet, identity: `${_user}`, discovery: { enabled: true, asLocalhost: true } });
...
//         await contract1.submitTransaction(_function_name, _key, `{"value":"${_value}"}`,`${_user}`);
