...
let c = new Common('goerli')
c.param('gasPrices', 'ecAddGas', 'byzantium') // 500

// Chain and hardfork provided
c = new Common('goerli', 'byzantium')
c.param('pow', 'minerReward') // 3000000000000000000

// Access genesis data for goerli network
...
```javascript
let c = new Common('goerli', null, ['byzantium', 'constantinople', 'petersburg'])
```
